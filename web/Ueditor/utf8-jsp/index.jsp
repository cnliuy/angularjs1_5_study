...
<body >
    ...
    <script type="text/javascript">
        angular.module('UeditorApp', ["ng.editor"])
                .controller("CTRL",["$scope",'$http',function($S,$http){
                        $S._simpleConfig = {
    ...
    <%--<div class="row" ng-controller="CTRL">--%>
        <div class="columns small-12">
            <h1>angular-ueditor 例子</h1>
                <div class="panel">
                    <h2>双向绑定</h2>
                    参考示例---angular-ueditor：
                    <a href="http://zqjimlove.github.io/angular-ueditor/">http://zqjimlove.github.io/angular-ueditor/</a>
                    <br><br>

                    <!--
                    <script id="editor" type="text/plain" style="width:1024px;height:500px;"
                            class="editor"  ng-model="content1">
                    </script>
                    -->
                    <div style="margin-bottom:1.25rem" class="editor" ng-model="content1" ></div>
                    <br>
                    <br>
